...
#define E137_DMX_FAIL_MODE								  0x0141	// toto nejak nefunguje, asi blbe PID, nebo
...
/* 0x8... -> SETUP 																												*/
#define ALP_PID_WORKLIGHT_ENABLED						0x8000	// ENABLE WORKLIGHT
#define ALP_PID_WORKLIGHT_LEVEL							0x8001	// BRIGHTNESS
#define ALP_PID_WORKLIGHT_LEVEL_RED						0x8002	// RED
#define ALP_PID_WORKLIGHT_LEVEL_GRN						0x8003	// GREEN
#define ALP_PID_WORKLIGHT_LEVEL_BLU						0x8004	// BLUE
#define ALP_PID_WORKLIGHT_LEVEL_WHI						0x8005	// WHITE
#define ALP_PID_WORKLIGHT_LEVEL_CHR						0x8008	// CHROMACITY
#define ALP_PID_ALWAYS_ON__CH1							0x8080	// ALWAYS ON - CH 1
#define ALP_PID_ALWAYS_ON__CH2							0x8081	// ALWAYS ON - CH 2
#define ALP_PID_ALWAYS_ON__CH3							0x8082	// ALWAYS ON - CH 3
#define ALP_PID_ALWAYS_ON__CH4							0x8083	// ALWAYS ON - CH 4
#define ALP_PID_HOLD_LAST_DMX_FAIL						0x8100
#define ALP_PID_CRMX_WIRELESS_DMX_ENABLED				0x8110
#define ALP_PID_ETHERNET_SACN_ENABLED					0x8120
#define ALP_PID_ETHERNET_SACN_UNIVERSE					0x8121
#define ALP_PID_ETHERNET_ARTNET_ENABLED					0x8130
#define ALP_PID_ETHERNET_ARTNET_UNIVERSE				0x8131
#define ALP_PID_FAN_MODE								0x8200
#define ALP_PID_SET_CHROMACITY_324456					0x8400	// CHROMACITY [0, 1, 2] -> [3200, 4400, 5600]

// PIDs GET only
//#define AII_PID_ETHERNET_SACN_ENABLED					0xC001
//#define AII_PID_ETHERNET_SACN_UNIVERSE					0xC002
//#define AII_PID_ETHERNET_ARTNET_ENABLED					0xC003
//#define AII_PID_ETHERNET_ARTNET_UNIVERSE				0xC004
//#define AII_PID_CHROMACITY_CALIBRATION					0xC005
//#define AII_PID_GET_OUTPUT_SERVICE_DATA					0xC006

// DC4 PIDs
#define DC4_PID_GET__HW_FW_INFO							0xDC40
#define DC4_PID_GO_TO_BOOTLOADER						0xDC41
#define DC4_PID_RESET_DEVICE							0xDC42
#define DC4_PID_GET_FLASH_PRECISION_CALIBRATION			0xDC48
#define DC4_PID_GET_DEVICE_RUNTIME_DATA					0xDC49
#define DC4_PID_GET_FLASH_CALIBRATION_DATA				0xDC4A
#define DC4_PID_SET_CALIBRATION_MODE					0xDC4B		// for set data = 0xDC; for exit data != 0xDC.
#define DC4_PID_SET_LIVE_CALIBR_CHAN_VALUES				0xDC4C
#define DC4_PID_SAVE_ALL_CALIBRATION_DATA				0xDC4D
#define DC4_PID_SAVE_PRECISION_CALIBRATION_DATA			0xDC4E
#define DC4_PID_LOAD_FIRMWARE							0xDC4F
// AII
#define AII_PID_FIXTURE_SERIAL_NUMBER					0xF000
#define AII_PID_SAVE_CALIBRATION_DATA					0xF0A3
...
#define SD_COLOR_CORRECTION								0x0208
#define SD_STROBE										0x0404
#define SD_CHROMACITY									0x8101
#define SD_FIXTURE_CONTROL								0x0502

/****************************************************************/
/* Status Messages ID 											*/
/****************************************************************/
#define STS_CAL_FAIL									0x0001		// Calibration Failed
#define STS_OVERTEMP									0x9021		// Overtemperature
#define STS_UNDERTEMP									0x0022		// Undertemperature

#define STS_MSG_DEFINITION__OVERTEMP	"Sensor %d over temp at %d °C    "
